...
export default function Card({
  ...
  if (variant === "car") {
    return (
      <div
        onClick={onClick}
        className="group rounded-2xl overflow-hidden bg-slate-800 border border-slate-700 hover:border-cyan-500/50 transition hover:shadow-2xl hover:shadow-cyan-500/20 cursor-pointer"
      >
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg font-semibold hover:shadow-lg hover:shadow-cyan-500/50 transition">
              Order
            </button>
          </div>
        </div>
